...
<div id="mySidenav" class="sidenav" style="text-align: center;">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
    ...
    <a href="#" class="list-group-item active">Bhopal</a>
...
<span onclick="openNav()" class="glyphicon glyphicon-menu-hamburger" style="font-size: 25px;"></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 30px;">Bhopal</span>
</div>
